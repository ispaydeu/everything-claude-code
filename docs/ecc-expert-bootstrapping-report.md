...
| **P1** | `.claude-plugin/plugin.json` | Plugin manifest — defines what gets installed via marketplace | Version, metadata, what is NOT in the manifest (hooks — see correction below) | **Now** |
